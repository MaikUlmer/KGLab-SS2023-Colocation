...
class Matcher:
    ...
    @staticmethod
    def link_workshops_dblp_conferences(workshops: List[Dict], number_key: str = "number", reload: bool = False) -> pd.DataFrame:
        """
    ...
    def link_wikidata_dblp_conferences(self, conference_ids: List[str],
        ...
        conference_info = get_dblp_conferences(reload)
